package org.example.core.ui.debug;
...
import org.example.core.ui.debug.nodes.*;
...
public class SystemExplorerWindow extends VisWindow implements EntityListener {
    ...
    public SystemExplorerWindow(Engine engine) {
        super("System Explorer");
        ...
        setResizable(true);
        setMovable(true);
        setSize(width, Gdx.graphics.getHeight() - 5);
        setPosition(Gdx.graphics.getWidth() - (width+1), 1);
        addCloseButton();
