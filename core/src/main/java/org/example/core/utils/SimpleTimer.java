...
public class SimpleTimer {
    ...
    public void reset() {
        lastEvent = MainGameScreen.getGameTimeCurrent();
    }
    ...
    public long timeSinceLastEvent() {
        return MainGameScreen.getGameTimeCurrent() - lastEvent;
    }
    ...
    public void setRatio(float ratio) {
        long newTime = MainGameScreen.getGameTimeCurrent() - (long)(ratio * interval);
